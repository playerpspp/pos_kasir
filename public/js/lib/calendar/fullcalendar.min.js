...
!(function (t) {
            ...
            (_.moment = function () {
                ...
                return (
                    "local" === _.options.timezone
                        ? ((t = Ot.moment.apply(null, arguments)),
                          t.hasTime() && t.local())
                        : (t =
                              "UTC" === _.options.timezone
                                  ? Ot.moment.utc.apply(null, arguments)
    ...
    function zt() {
        ...
        function F(n, i) {
            ...
            if (
                ...
                t.extend(l, n),
                i && (l.source = i),
                (l._id = n._id || (void 0 === n.id ? "_fc" + Se++ : n.id + "")),
                n.className
                    ? "string" == typeof n.className
    ...
    (Ot.intersectRanges = F),
        ...
        (Ot.cssToStr = nt),
        (Ot.proxy = lt),
        (Ot.capitaliseFirstLetter = rt),
        (Ot.getOuterRect = h),
        (Ot.getClientRect = f),
        (Ot.getContentRect = g),
        (Ot.getScrollbarWidths = p);
    var Pt = null;
    (Ot.preventDefault = H),
        (Ot.intersectRects = x),
        (Ot.parseFieldSpecs = L),
        (Ot.compareByFieldSpecs = M),
        (Ot.compareByFieldSpec = B),
        (Ot.flexibleCompare = N),
        (Ot.computeIntervalUnit = A),
        (Ot.divideRangeByDuration = P),
        (Ot.divideDurationByDuration = _),
        (Ot.multiplyDuration = Y),
        (Ot.durationHasTime = W);
    ...
    $t.push("_fullCalendar"),
        ...
        (qt.week = qt.weeks =
            function (t) {
                ...
                return null == t && "function" == typeof e
                    ? e(this)
                    : "ISO" === e
                    ? Zt.isoWeek.apply(this, arguments)
                    : Zt.week.apply(this, arguments);
            }),
        (qt.time = function (t) {
        ...
        (qt.local = function (t) {
            return (
                Zt.local.call(this, this._ambigZone || t),
                (this._ambigTime = !1),
                (this._ambigZone = !1),
                this
            );
        ...
        (qt.utcOffset = function (t) {
            return (
                ...
                Zt.utcOffset.apply(this, arguments)
            );
        }),
        (qt.format = function () {
            return this._fullCalendar && arguments[0]
                ...
                ? Kt(this, "YYYY-MM-DD")
                : this._ambigZone
                ? Kt(this, "YYYY-MM-DD[T]HH:mm:ss")
                : Zt.format.apply(this, arguments);
        }),
        (qt.toISOString = function () {
            return this._ambigTime
                ...
                : this._ambigZone
                ? Kt(this, "YYYY-MM-DD[T]HH:mm:ss")
                : Zt.toISOString.apply(this, arguments);
        }),
        (function () {
            function t(t, e) {
            ...
            function n(t, e, n, s, o) {
                var l;
                return (
                    (t = Ot.moment.parseZone(t)),
                    (e = Ot.moment.parseZone(e)),
                    (l = t.localeData()),
                    (n = l.longDateFormat(n) || n),
                    i(r(n), t, e, s || " - ", o)
                );
            }
            function i(t, e, n, i, r) {
                var s,
                    ...
                    y = "",
                    S = "";
                for (s = 0; s < a.length && (!a[s] || u.isSame(c, a[s])); s++)
                    p += f[s];
                for (
                    o = a.length - 1;
                    o > s &&
            ...
            (Ot.formatDate = t),
                (Ot.formatRange = n),
                (Ot.oldMomentFormat = e),
                (Ot.queryMostGranularFormatUnit = f);
            var g = "\v",
                p = "",
                v = "",
        ...
        ie = (Ot.DragListener = ct.extend(te, {
            ...
            bindHandlers: function () {
                ...
                this.isTouch
                    ...
                    this.listenTo(t, { selectstart: H, contextmenu: H });
            },
    ...
    var re = ie.extend({
                ...
                t
                    ? ((n = { left: E(t), top: b(t) }),
                      ...
                      r &&
                          ...
                          (this.origHit && (e = x(this.origHit, e) || e),
                          (i = I(e))),
                      (this.coordAdjust = k(i, n)))
                    : ((this.origHit = null), (this.coordAdjust = null)),
                ie.prototype.handleInteractionStart.apply(this, arguments);
        },
        handleDragStart: function (t) {
            var e;
            ie.prototype.handleDragStart.apply(this, arguments),
                (e = this.queryHit(E(t), b(t))),
                e && this.handleHitOver(e);
        },
        handleDrag: function (t, e, n) {
            var i;
            ie.prototype.handleDrag.apply(this, arguments),
                (i = this.queryHit(E(n), b(n))),
                pt(i, this.hit) ||
        ...
        handleDragEnd: function () {
            this.handleHitDone(),
                ie.prototype.handleDragEnd.apply(this, arguments);
        },
        ...
        handleInteractionEnd: function () {
            ie.prototype.handleInteractionEnd.apply(this, arguments),
                (this.origHit = null),
                (this.hit = null),
                this.component.hitsNotNeeded();
        },
        handleScrollEnd: function () {
            ie.prototype.handleScrollEnd.apply(this, arguments),
                this.isDragging &&
    ...
    var oe = ct.extend(te, {
            ...
            handleMove: function (t) {
                (this.topDelta = b(t) - this.y0),
                    (this.leftDelta = E(t) - this.x0),
                    this.isHidden || this.updatePosition();
            },
            hide: function () {
                this.isHidden ||
                ...
                var t,
                    ...
                    i = new re(this, {
                        ...
                        hitOver: function (n, i, r) {
                            r &&
                                ((t = e.computeSelection(
                                    e.getHitSpan(r),
                                    e.getHitSpan(n)
                                )),
                                t ? e.renderSelection(t) : t === !1 && s());
                        },
                        hitOut: function () {
    ...
    le.mixin({
                    ...
                    delete t.component,
                        n.stop(!i, function () {
                            e && (l.unrenderDrag(), r.segDragStop(t, s)),
                                i
                                    ? l.reportSegDrop(t, i, r.largeUnit, u, s)
                                    : l.showEvent(c);
                        }),
                ...
                h = (this.segResizeListener = new re(this, {
                    ...
                    interactionEnd: function (e) {
                        n && r.segResizeStop(t, e),
                            i
                                ? l.reportSegResize(t, i, r.largeUnit, u, e)
                                : l.showEvent(c),
        ...
        invertRanges: function (t) {
            var e,
                ...
                o = [],
                l = r;
            for (t.sort(bt), e = 0; e < t.length; e++)
                (n = t[e]),
    ...
    ue.mixin({
        ...
        unrenderEvents: function () {
            this.removeSegPopover(),
                le.prototype.unrenderEvents.apply(this, arguments);
        },
        getEventSegs: function () {
            return le.prototype.getEventSegs
                .call(this)
        ...
        renderSegRow: function (e, n) {
            ...
            for (r = 0; r < f; r++) {
                ...
                i(d), this.productendCells(l), g.append(l);
            }
            return {
                row: e,
                tbodyEl: g,
    ...
    var ce = (Ot.TimeGrid = le.extend(ae, {
        ...
        computeLabelInterval: function (t) {
            ...
            for (n = Re.length - 1; n >= 0; n--)
                if (((i = e.duration(Re[n])), (r = _(i, t)), ot(r) && r > 1))
                    return i;
            return e.duration(t);
        },
        computeEventTimeFormat: function () {
    ...
    ce.mixin({
        ...
        renderContentSkeleton: function () {
            ...
            (n = t(
                ...
                this.productendCells(n.find("tr")),
                this.el.append(n);
        },
        renderFgSegs: function (t) {
            return (
    ...
    var de = (Ot.View = ct.extend(Jt, te, {
            ...
            constructor: function (t, n, i, r) {
                (this.calendar = t),
                    ...
                    (this.dateRenderQueue = new gt()),
                    (this.eventRenderQueue = new gt(
            ...
            computeTitle: function () {
                ...
                return (
                    ...
                    "month" === this.intervalUnit
                        ? ((t = this.intervalStart), (e = this.intervalEnd))
            ...
            formatRange: function (t, e, n) {
                ...
                return (
                    ...
                    Xt(t.start, i, e, n, this.opt("isRTL"))
                );
            },
            ...
            whenEventsSet: function () {
                ...
                return this.isEventsSet
                    ? ft.resolve(this.getCurrentEvents())
                    : new ft(function (e) {
                          t.one("eventsSet", e);
                      });
            },
            ...
            reportSegDrop: function (t, e, n, i, r) {
                ...
                this.triggerEventDrop(t.event, o.dateDelta, l, i, r),
                    s.reportEventChange();
            },
            ...
            reportSegResize: function (t, e, n, i, r) {
                ...
                this.triggerEventResize(t.event, o.durationDelta, l, i, r),
                    s.reportEventChange();
            },
    ...
    fe.mixin(Jt),
        ...
        (fe.englishDefaults = { dayPopoverFormat: "dddd, MMMM D" }),
        (fe.rtlDefaults = {
    ...
    Ot.locale("en", fe.englishDefaults),
        (Ot.sourceNormalizers = []),
        (Ot.sourceFetchers = []);
    var ye = { dataType: "json", cache: !1 },
        Se = 1;
    (fe.prototype.mutateSeg = function (t, e) {
        return this.mutateEvent(t.event, e);
    }),
        (fe.prototype.normalizeEvent = function (t) {}),
        (fe.prototype.spanContainsSpan = function (t, e) {
    ...
    var Ee = (Ot.BasicView = de.extend({
            ...
            setRange: function (t) {
                de.prototype.setRange.call(this, t),
        ...
        De = (Ot.MonthView = Ee.extend({
            computeRange: function (t) {
                var e,
                    n = Ee.prototype.computeRange.call(this, t);
                return (
                    this.isFixedWeeks() &&
    ...
    (At.basic = { class: Ee }),
        (At.basicDay = { type: "basic", duration: { days: 1 } }),
        (At.basicWeek = { type: "basic", duration: { weeks: 1 } }),
        (At.month = {
            class: De,
            duration: { months: 1 },
    ...
    var Te = (Ot.AgendaView = de.extend({
            ...
            updateSize: function (t) {
                this.timeGrid.updateSize(t),
                    de.prototype.updateSize.call(this, t);
            },
            updateWidth: function () {
    ...
    (At.agenda = {
        ...
        (At.agendaDay = { type: "agenda", duration: { days: 1 } }),
        (At.agendaWeek = { type: "agenda", duration: { weeks: 1 } });
    var Ie = de.extend({
            grid: null,
            scroller: null,
            initialize: function () {
                (this.grid = new ke(this)),
                    (this.scroller = new he({
                        overflowX: "hidden",
                        overflowY: "auto",
                    }));
        ...
        ke = le.extend({
            ...
            handleSegClick: function (e, n) {
                var i;
                le.prototype.handleSegClick.apply(this, arguments),
