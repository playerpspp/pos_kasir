(function (g) {
    ...
    function v(a) {
        n === p &&
            (n =
                ...
                w
                    .serializeToString(
                        g.parseXML(o["xl/worksheets/sheet1.xml"])
                    )
                    .indexOf("xmlns:r"));
    ...
    var x = function (a, b) {
        ...
        r = function (a, b) {
            ...
            -1 !== d.indexOf("*") &&
                (d = g.trim(d.replace("*", g("title").text())));
    ...
    var o = {
            "_rels/.rels":
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workproduct.xml"/></Relationships>',
            "xl/_rels/workproduct.xml.rels":
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/><Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/></Relationships>',
            "[Content_Types].xml":
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Default Extension="xml" ContentType="application/xml" /><Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml" /><Default Extension="jpeg" ContentType="image/jpeg" /><Override PartName="/xl/workproduct.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml" /><Override PartName="/xl/worksheets/sheet1.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml" /><Override PartName="/xl/styles.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml" /></Types>',
            "xl/workproduct.xml":
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workproduct xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><fileVersion appName="xl" lastEdited="5" lowestEdited="5" rupBuild="24816"/><workproductPr showInkAnnotation="0" autoCompressPictures="0"/><productViews><workproductView xWindow="0" yWindow="0" windowWidth="25600" windowHeight="19020" tabRatio="500"/></productViews><sheets><sheet name="" sheetId="1" r:id="rId1"/></sheets></workproduct>',
        ...
        action: function (a, b, d, c) {
            var a = c._flash,
                ...
                d = {
                    ...
                    xl: {
                        _rels: {
                            "workproduct.xml.rels": g.parseXML(
                                o["xl/_rels/workproduct.xml.rels"]
                            ),
                        },
                        "workproduct.xml": g.parseXML(o["xl/workproduct.xml"]),
            ...
            g("sheets sheet", d.xl["workproduct.xml"]).attr("name", B(c));
